PKG?=github.com/camptocamp/puppetca-issuer
BINNAME?=manager
PREFIX?=
...
IMG ?= camptocamp/puppetca-issuer:latest
...
docker-tag:
	$(call DOCKER_TAG,camptocamp/puppetca-issuer,$(VERSION))

docker-push-tag: docker-tag
	$(call DOCKER_PUSH,camptocamp/puppetca-issuer,$(VERSION))

docker-push-tag-latest:
	$(call DOCKER_PUSH,camptocamp/puppetca-issuer,latest)
