...
func (in *PuppetCAIssuerCondition) DeepCopy() *PuppetCAIssuerCondition {
	if in == nil {
		return nil
	}
	out := new(PuppetCAIssuerCondition)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PuppetCAIssuerStatus) DeepCopyInto(out *PuppetCAIssuerStatus) {
	*out = *in
	if in.Conditions != nil {
		...
		*out = make([]PuppetCAIssuerCondition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
